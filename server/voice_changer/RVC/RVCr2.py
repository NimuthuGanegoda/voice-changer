...
class RVCr2(VoiceChangerModel):
    ...
    def generate_input(
        ...
        # rawVol is kept separately so the silence skip still triggers (the decayed value
        # would stay above silentThreshold for minutes and waste inference on silence).
        self.rawVol = rawVol
